...
def main(script_args, training_args, model_args):
    ...
    dataset = load_from_disk('/projects/EEHPC-DEV-2024D11-005/momin/datasets/coco/qwen_coco_grpo_iou_3obj')
    ...
    trainer = trainer_cls(
        model='/projects/EEHPC-DEV-2024D11-005/momin/Qwen2.5-VL-3B-Instruct',
